...
from models.models import FCN_Encoder, FCN_Encoder2
...
pretrain_default_model_kwargs = {
    'DAN_encoder': dict(),
    'DAN_encoder2': dict(drop_path_rate=0.02),
    'resnet18': dict(drop_path_rate=0.02),
...
def build_sparse_encoder(name: str, input_size, sbn=False, drop_path_rate=0.0, verbose=False, exportDirectory=None):
