...
class Args(Tap):
    ...
    #data_path: str = f'{Path.home()}/dev/python/formatted/IAM_page/train'  # path to training data
    #data_path: str = f'{Path.home()}/dev/python/formatted/IAM_224/train'
    #data_path = f"{Path.home()}/dev/python/formatted/RD_BAUTZEN_224/classes"
    #data_path: str = f'{Path.home()}/dev/python/formatted/IAM_non_syn_line/train'
    ...
    # resume_from: str = f'{Path.home()}/dev/python/SparK/Pre_DAN_IAM_line_64h_16x16_40perc_garbagel1/DAN_encoder_1kpretrained_timm_style.pth'     
    # SparK hyperparameters
    #resume_from: str = f'{Path.home()}/dev/python/SparK/{exp_dir}/DAN_encoder_withdecoder_1kpretrained_spark_style_27.pth'
